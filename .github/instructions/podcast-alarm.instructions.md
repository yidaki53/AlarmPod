...
- Disabled alarm settings should not advertise exact-alarm permission work. Keep the visibility rule aligned with the active schedule state, not just with platform capability.
